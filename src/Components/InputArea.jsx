...
export default function InputArea({ ...props }) {
  ...
  return (
    <label className="block relative py-3 ">
      ...
      <small className=" absolute flex text-lg text-[#E7E9EA]  right-2 -translate-y-1/2 cursor-text pointer-events-none top-6 scale-[0.8333] invisible  peer-focus:visible peer-valid:visible">
        0 / {props.maxLength}
      </small>
    </label>
  );
